...
QT_MOC_LITERAL(4, 38, 10), // "draw_laser"
QT_MOC_LITERAL(5, 49, 25), // "RoboCompLaser::TLaserData"
QT_MOC_LITERAL(6, 75, 5), // "ldata"
QT_MOC_LITERAL(7, 81, 10), // "initialize"
QT_MOC_LITERAL(8, 92, 6), // "period"
QT_MOC_LITERAL(9, 99, 15), // "new_target_slot"
QT_MOC_LITERAL(10, 115, 5) // "point"

    },
    "SpecificWorker\0compute\0\0startup_check\0"
    "draw_laser\0RoboCompLaser::TLaserData\0"
    "ldata\0initialize\0period\0new_target_slot\0"
    "point"
};
...
void SpecificWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->draw_laser((*reinterpret_cast< const RoboCompLaser::TLaserData(*)>(_a[1]))); break;
        case 3: _t->initialize((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->new_target_slot((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        default: ;
        }
    }
}
